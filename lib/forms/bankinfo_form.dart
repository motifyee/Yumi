...
class BankInfoFormSubmitButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<BankInfoFormBloc, BankInfoFormState>(
        ...
        builder: (context, state) => Column(
              children: [
                TextFormFieldTemplate(
                  ...
                  onChange: (value) {
                    context.read<BankInfoFormBloc>().add(
                        BankInfoFormUpdateEvent(
                            bankInfo:
                                state.bankInfo.copyWith(bankName: value)));
                  },
                ),
                ...
                TextFormFieldTemplate(
                  ...
                  onChange: (value) {
                    context.read<BankInfoFormBloc>().add(
                        BankInfoFormUpdateEvent(
                            bankInfo:
                                state.bankInfo.copyWith(accountName: value)));
                  },
                ),
                SizedBox(height: ThemeSelector.statics.defaultLineGap * 2),
                TextFormFieldTemplate(
                ...
                TextFormFieldTemplate(
                  ...
                  onChange: (value) {
                    context.read<BankInfoFormBloc>().add(
                        BankInfoFormUpdateEvent(
                            bankInfo:
                                state.bankInfo.copyWith(currency: value)));
                  },
                ),
                SizedBox(height: ThemeSelector.statics.defaultLineGap * 2),
                TextFormFieldTemplate(
                ...
                TextFormFieldTemplate(
                  ...
                  onChange: (value) {
                    context.read<BankInfoFormBloc>().add(
                        BankInfoFormUpdateEvent(
                            bankInfo:
                                state.bankInfo.copyWith(swiftCode: value)));
                  },
                ),
                SizedBox(height: ThemeSelector.statics.defaultLineGap * 2),
                TextFormFieldTemplate(
                  ...
                  onChange: (value) {
                    context.read<BankInfoFormBloc>().add(
                        BankInfoFormUpdateEvent(
                            bankInfo:
                                state.bankInfo.copyWith(branchAddress: value)));
                  },
                ),
              ],
            ));
