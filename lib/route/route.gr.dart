...
class BasketRoute extends _i23.PageRouteInfo<void> {
  const BasketRoute({List<_i23.PageRouteInfo>? children})
      : super(
          BasketRoute.name,
...
class CustomerWalletRoute extends _i23.PageRouteInfo<CustomerWalletRouteArgs> {
  CustomerWalletRoute({
    _i24.Key? key,
    List<_i23.PageRouteInfo>? children,
  }) : super(
  ...
  static const _i23.PageInfo<CustomerWalletRouteArgs> page =
      _i23.PageInfo<CustomerWalletRouteArgs>(name);
}
