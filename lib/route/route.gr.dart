...
class ChefProfileRoute extends _i20.PageRouteInfo<ChefProfileRouteArgs> {
  ChefProfileRoute({
    _i21.Key? key,
  ...
  static const _i20.PageInfo<ChefProfileRouteArgs> page =
      _i20.PageInfo<ChefProfileRouteArgs>(name);
}
...
class DocumentationRoute extends _i20.PageRouteInfo<void> {
  const DocumentationRoute({List<_i20.PageRouteInfo>? children})
      : super(
...
class OrderStatusRoute extends _i20.PageRouteInfo<void> {
  const OrderStatusRoute({List<_i20.PageRouteInfo>? children})
      : super(
...
class PaymentPaypalRoute extends _i20.PageRouteInfo<void> {
  const PaymentPaypalRoute({List<_i20.PageRouteInfo>? children})
      : super(
...
class PaymentVisaRoute extends _i20.PageRouteInfo<PaymentVisaRouteArgs> {
  PaymentVisaRoute({
    _i21.Key? key,
    List<_i20.PageRouteInfo>? children,
  }) : super(
  ...
  static const _i20.PageInfo<PaymentVisaRouteArgs> page =
      _i20.PageInfo<PaymentVisaRouteArgs>(name);
}
