  ...
  List<CustomRoute> get routes => [
        CustomRoute(
          ...
          children: [
            ...
            CustomRoute(path: 'signup', page: SignUpRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
            CustomRoute(path: 'addPhone', page: AddPhoneRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
            CustomRoute(path: 'otp', page: OTPRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
            CustomRoute(path: 'location', page: LocationRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
          ],
        ),
        ...
        CustomRoute(page: SettingsRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
        ...
        CustomRoute(page: MyOrdersRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
        CustomRoute(page: ChefCustomerAddressRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
        CustomRoute(path: '/customer_location', page: LocationRoute.page, transitionsBuilder: TransitionsBuilders.slideLeftWithFade),
      ];
}
