              ...
              TextButton(
                  onPressed: () {
                    showDialog(
                      ...
                      context.read<CategoriesBloc>().add(GetCategoriesEvent(context: context, isPreOrder: menuTarget == MenuTarget.preOrder, isAll: false));
                        ...
                        builder: (ctx) => DeleteDialogTemplate(
                              actions: () async {
                                ...
                                return await MealService.deleteMeal(context: context, mealModel: meal).then((res) {
                                  ...
                                  context.read<CategoriesBloc>().add(GetCategoriesEvent(context: context, isPreOrder: meal.isPreOrder == true, isAll: false));
