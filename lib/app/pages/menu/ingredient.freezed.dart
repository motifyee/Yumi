...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String? code, String? name, double? portionGrams});
}
...
class _$IngredientImpl implements _Ingredient {
  const _$IngredientImpl({this.id, this.code, this.name, this.portionGrams});
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      final String? code,
      final String? name,
      final double? portionGrams}) = _$IngredientImpl;
