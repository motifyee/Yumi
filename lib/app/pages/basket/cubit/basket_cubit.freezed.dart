...
abstract class $BasketStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Basket basket, bool isPickUpOnly});
...
class _$BasketStateImpl implements _BasketState {
  const _$BasketStateImpl({required this.basket, required this.isPickUpOnly});
  ...
  @override
  String toString() {
    return 'BasketState(basket: $basket, isPickUpOnly: $isPickUpOnly)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, basket, isPickUpOnly);
...
abstract class _BasketState implements BasketState {
  const factory _BasketState(
      ...
      required final bool isPickUpOnly}) = _$BasketStateImpl;
