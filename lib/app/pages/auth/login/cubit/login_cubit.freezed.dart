...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({LoginData loginData, bool isLoading});
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {this.loginData = const LoginData(email: '', password: ''),
  ...
  @override
  String toString() {
    return 'LoginState(loginData: $loginData, isLoading: $isLoading)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loginData, isLoading);
...
abstract class _Initial implements LoginState {
  const factory _Initial({final LoginData loginData, final bool isLoading}) =
      _$InitialImpl;
