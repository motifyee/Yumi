...
class GetAddresses extends UseCase<PaginatedData<Address>, GetAddressesParams> {
  ...
  GetAddresses({AddressRepo? addressRepo}) : addressRepo = addressRepo ?? getIt<AddressRepo>();

  @override
  Future<Either<Failure, PaginatedData<Address>>> call(GetAddressesParams params) async {
    return await addressRepo.getAddresses(pagination: params.pagination, queryParameters: params.queryParameters).run();
  }
}
