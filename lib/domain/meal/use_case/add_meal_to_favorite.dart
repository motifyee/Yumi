...
class AddMealToFavorite extends UseCase<PaginatedData<Meal>, AddMealToFavoriteParams> {
  final MealRepo mealRepo;

  AddMealToFavorite({MealRepo? mealRepo}) : mealRepo = mealRepo ?? getIt<MealRepo>();

  @override
  Future<Either<Failure, PaginatedData<Meal>>> call(AddMealToFavoriteParams params) {
