...
class MealRepoRemote extends MealRepo {
  ...
  @override
  TaskEither<Failure, Meal> addMealToFavorite({required Meal meal}) => TaskEither.tryCatch(() => mealSource.addMealToFavorite(meal: meal), (error, stackTrace) => ServerFailure(error, stackTrace));

  @override
  TaskEither<Failure, String> createMeal({required Meal meal}) => TaskEither.tryCatch(() => mealSource.createMeal(meal: meal), (error, stackTrace) => ServerFailure(error, stackTrace));
  ...
  @override
  TaskEither<Failure, Meal> removeMealToFavorite({required Meal meal}) => TaskEither.tryCatch(() => mealSource.removeMealToFavorite(meal: meal), (error, stackTrace) => ServerFailure(error, stackTrace));

  @override
  TaskEither<Failure, String> updateMeal({required Meal meal}) => TaskEither.tryCatch(() => mealSource.updateMeal(meal: meal), (error, stackTrace) => ServerFailure(error, stackTrace));
}
