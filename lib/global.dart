...
extension GX on GlobalContext {
  bool get isChefApp =>
      GlobalContext().app.config.appTitle == YumiApp.chefs.name;
  bool get isDriverApp =>
      GlobalContext().app.config.appTitle == YumiApp.drivers.name;
  bool get isCustomerApp =>
      GlobalContext().app.config.appTitle == YumiApp.customers.name;

  String get appName => GlobalContext().app.config.appTitle;
}
...
// class GG {
  ...
  // static App get yumiApp => App.of(cContext);
  // static YumiApp get appTarget => YumiApp.drivers;
  // //yumiApp.config.appTargetUser;

  // static bool get isChefApp => false;
  // // yumiApp.config.appTargetUser == AppTargetUser.chefs;
  // static bool get isDriverApp => true;
  // // yumiApp.config.appTargetUser == AppTargetUser.drivers;
  // static bool get isCustomerApp => false;
  // // yumiApp.config.appTargetUser == AppTargetUser.customers;

  // static String get appName => 'dirver'; //yumiApp.config.appTargetUser.name;
