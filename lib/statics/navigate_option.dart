...
class NavigateOptions {
  ...
  static List<NavigateListItem> navigateListDrivers = [
    ...
    NavigateListItem(icon: SvgPicture.asset('assets/images/setting.svg'), selectedIcon: SvgPicture.asset('assets/images/setting1.svg', fit: BoxFit.fitWidth), title: S.current.setting, page: const SettingsScreen()),
  ];
              ...
              if (state.isSignalTriggered(signal: [
                ...
                Positioned(
                    ...
                    child: Container(
                      width: CommonDimens.defaultInputGap,
                      height: CommonDimens.defaultInputGap,
                      decoration: BoxDecoration(color: CommonColors.primary, borderRadius: BorderRadius.circular(CommonDimens.defaultInputGap)),
                    ))
            ],
          );
        },
