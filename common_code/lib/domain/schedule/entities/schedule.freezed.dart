...
/// @nodoc
mixin _$ScheduleDay {
  ScheduleWeekDay? get name => throw _privateConstructorUsedError;
...
abstract class $ScheduleDayCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {ScheduleWeekDay? name, bool? active, TimeOfDay? start, TimeOfDay? end});
}
