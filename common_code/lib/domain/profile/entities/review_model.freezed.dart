...
//
  ...
  @override
  String toString() {
    return 'ReviewModel(id: $id, code: $code, buddiesUserId: $buddiesUserId, customerName: $customerName, rate: $rate, reviewComment: $reviewComment, chef: $chef)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, code, buddiesUserId,
      customerName, rate, reviewComment, chef);
