...
class RemoveIngredientsForm extends UseCase<List<Ingredient>, RemoveIngredientsFormParams> {
  @override
  Future<Either<Failure, List<Ingredient>>> call(RemoveIngredientsFormParams params) async {
