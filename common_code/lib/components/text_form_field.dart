  ...
  Widget build(BuildContext context) {
    ...
    InputDecoration inputDecoration = InputDecoration(
      ...
      contentPadding: widget.isDense == true
          ...
          : EdgeInsets.symmetric(
              horizontal: widget.borderStyle!.inputIndent,
              vertical: CommonDimens.defaultInputGap,
            ),
      ...
      suffixIcon: widget.isPassword
          ? IconButton(
              ...
              icon: Icon(
                ...
                color: CommonColors.secondary.withOpacity(.6),
              ),
            )
          : widget.suffixIcon,
...
class TextFormFieldBorderStyle {
  static TextFormFieldBorderStyleType borderedRound =
    ...
    borderRadius: CommonDimens.buttonBorderRadiusRounded,
    color: CommonColors.secondaryFaint,
    focusColor: CommonColors.primary,
    inputIndent: CommonDimens.defaultGap,
  );

  static TextFormFieldBorderStyleType borderedCircle =
      TextFormFieldBorderStyleType(
    borderRadius: CommonDimens.buttonBorderRadius,
    color: CommonColors.secondary,
    focusColor: CommonColors.primary,
    inputIndent: CommonDimens.defaultBlockGap,
  );
